...
na=1; nb=1; nd=1; ne=1;
kct_range = 10*10^12; kcr_range = 10*10^12; kcs_range = 10*10^9; knrc_range = 10*10^8;
fluences=[0.5 2.5 10 60]'*10^17;
n_fluences=3;
...
sun = 1.9401*10^20*logspace(1,15,60);
...
%                  
                    ...
                    for n_sun=1:length(sun)
                        ...
                        total_carrier_temp(n_sun) = c(end,1)+c(end,2)+c(end,3);
                        ...
                        total_carrier = [total_carrier total_carrier_temp(n_sun)];
...
% legend
fig
semilogx(total_carrier(2:end),C_frac_to_plot(2:end))
